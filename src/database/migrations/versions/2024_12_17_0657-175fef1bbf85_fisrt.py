...
Revision ID: 175fef1bbf85
Revises: 
Create Date: 2024-12-17 06:57:13.255530
...
def upgrade() -> None:
    ...
    sa.Column('sex', sa.Enum('MALE', 'WOMEN', 'NOT_SETUP', name='sex'), nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('updated', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('change_to_id', sa.BigInteger(), nullable=False),
